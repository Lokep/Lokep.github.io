/**
 * Created by yeebee on 2018/4/16.
 */
/*店铺列表的tab选项卡*/
...
$(function () {
    ...
    $('.shopTabHeader>span').click(function () {
        var index = $(this).index()-1;
        $(this).parent().next().css('margin-left',index*-100+'%');
        $(this).siblings().removeClass('shopTabActive');
        $(this).addClass('shopTabActive');
        $(this).siblings('i').css('left',index*102+'px');
    });
    ...
    $('.tabList>li').click(function () {
        ...
        $(this).parent().parent().next().css('margin-left',index*-1020+'px');
        $(this).siblings().removeClass('tabClicked');
        $(this).addClass('tabClicked');
        $(this).parent().siblings('.slipBlock').css('left',index*100+'px');

        TabContent.css('height',0);
        TabContent.eq(index).css('height','auto');
    ...
    MenuContent.find('li').click(function () {
        ...
        var delta =index<=1? Math.ceil(MenuContent.eq(index+1).find('li').length/12):1;
